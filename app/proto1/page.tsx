    ...
    const experiences = [
        {
            ...
            details: "理想のライフスタイルから3ヶ月・1ヶ月・1週間・1日のタスクに自動分解",
    ...
    return (
        <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white min-h-screen">
            ...
            <div className="fixed top-0 left-0 w-full z-50 bg-black/20 backdrop-blur-sm">
                <div className="h-1 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 transition-all duration-300"
                    style={{ width: `${scrollProgress}%` }} />
                <div className="flex justify-between px-8 py-2 text-xs">
                    <span className="text-gray-400">10分プレゼンテーション</span>
                    <span className="text-purple-400 font-bold">{Math.round(scrollProgress)}%</span>
                </div>
            </div>
            ...
            <section className="min-h-screen flex flex-col justify-center items-center relative px-8">
                ...
                <div className="z-10 text-center space-y-8 max-w-4xl">
                    <h1 className="text-7xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 
                    ...
                    <h2 className="text-4xl font-light">
                        AI共通プラットフォーム構築で
                        <br />
                        <span className="font-bold text-purple-400">ビジネス価値を創出</span>
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                title: "プロジェクト推進",
                                description: "複数ステークホルダーとの協働とアジャイル開発の実践"
                            },
                            {
                            ...
                            hover:shadow-2xl hover:shadow-purple-500/20 cursor-pointer"
                                onMouseEnter={() => setHoveredCard(`contrib-${index}`)}
                                onMouseLeave={() => setHoveredCard(null)}>
                                <div className={`text-purple-400 mb-4 transition-transform duration-300 
                               ${hoveredCard === `contrib-${index}` ? 'scale-110' : ''}`}>
                                    {item.icon}
                                </div>
                        ...
                        <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 
                          border border-purple-500/30 backdrop-blur-sm">
                            ...
                            <ul className="space-y-2 text-gray-300">
                                <li>✓ 複数のステークホルダーが関わるプロジェクトのリード経験</li>
                        ...
                        <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl p-8 
                          border border-blue-500/30 backdrop-blur-sm">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {['TypeScript', 'Next.js', 'Python', 'Dify', 'Tailwind CSS', 'スクラム開発'].map((tech) => (
                                    <span key={tech}
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {experiences.map((exp) => (
                            ...
                            border border-white/10 p-8 cursor-pointer
                            transform transition-all duration-500 hover:scale-[1.02]"                                onMouseEnter={() => setHoveredCard(exp.id.toString())}
                                onMouseLeave={() => setHoveredCard(null)}>
                              ...
                              opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-start justify-between mb-4">
                                        <div className={`text-purple-400 transition-all duration-300 
                                   ${hoveredCard === exp.id.toString() ? 'scale-110 rotate-6' : ''}`}>
                                            {exp.icon}
                                        </div>
                                    ...
                                    <p className="text-sm text-gray-400 mb-4">{exp.details}</p>                                    <div className={`overflow-hidden transition-all duration-500 
                                  ${hoveredCard === exp.id.toString() ? 'max-h-40' : 'max-h-0'}`}>
                                        <div className="pt-4 border-t border-white/10">
                                            ...
                                            {exp.beforeUrl && (
                                                <div className="space-y-1">
                                                    <a href={exp.beforeUrl} target="_blank" rel="noopener noreferrer"
                                                        className="block text-sm text-blue-400 hover:text-blue-300 underline">
                                                        Before →
                                                    </a>
                                                    <a href={exp.afterUrl} target="_blank" rel="noopener noreferrer"
                                                        className="block text-sm text-blue-400 hover:text-blue-300 underline">
                                                        After →
                                                    </a>
                                                </div>
                ...
                <div className="max-w-4xl text-center">
                    ...
                    <div className="space-y-8 text-2xl leading-relaxed">
                        <p className="animate-fade-in-up">
                            <span className="text-purple-400 font-bold">技術的挑戦</span>を楽しみながら
                        </p>
                        <p className="animate-fade-in-up animation-delay-200">
                            <span className="text-blue-400 font-bold">ビジネス価値</span>を創出し
                        </p>
                        <p className="animate-fade-in-up animation-delay-400">
                            <span className="text-pink-400 font-bold">全社の生産性向上</span>に貢献します
                        </p>
                    </div>

                    <div className="mt-16 animate-fade-in-up animation-delay-600">
                        <div className="inline-block px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 
                          rounded-full text-xl font-bold transform hover:scale-105 transition-transform
